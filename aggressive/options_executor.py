...
class OptionsExecutor:
    ...
    def close_position_live(self, pos):
        ...
        elif stype == "DUAL_STRATEGY":
            # Execute as two separate legs
            logger.info(f"DUAL_STRATEGY: executing as multi-leg")
            return self._execute_debit_spread(trade)  # Route to spread executor
        else:
